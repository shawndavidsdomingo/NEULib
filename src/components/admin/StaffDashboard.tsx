...
export default function StaffDashboard({ onExit, adminData, user, onSwitchToStudent }: StaffDashboardProps) {
  ...
  const dept     = adminData?.deptID ? `${adminData.deptID}${adminData.program ? ' · ' + adminData.program : ''}` : 'Library Staff';
      ...
      <aside className="hidden lg:flex w-64 xl:w-72 flex-col flex-shrink-0 sticky top-0 h-screen"
        ...
        <div className="p-5 border-b border-white/10 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-white/40 font-medium" style={{ fontSize: '0.78rem', letterSpacing: '0.1em', textTransform: 'uppercase' }}>Staff Console</p>
          </div>
        </div>
